...
const Contact = () => {
  ...
  return (
    <section id="contact" className="section-padding relative overflow-hidden bg-slate-950/60 border-t border-slate-900">
      <div className="container-custom">
        ...
        <div className="mb-12">
          ...
          <h2 className="heading-lg tracking-tight uppercase">
            LET&apos;S BUILD SOMETHING <span className="text-blue-400">RELIABLE.</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="p-6 rounded-2xl bg-slate-900/80 border border-slate-800 space-y-6">
              ...
              <div className="space-y-4 font-mono text-xs">
                <a
                  ...
                  className="flex items-center gap-3 p-3 rounded-xl bg-slate-950/80 border border-slate-800 text-slate-300 hover:text-blue-400 hover:border-slate-700 transition-colors"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-3 p-3 rounded-xl bg-slate-950/80 border border-slate-800 text-slate-300 hover:text-white hover:border-slate-700 transition-colors"
                >
            ...
            {/* Quick Status Box */}
            <div className="p-6 rounded-2xl bg-blue-950/20 border border-blue-900/40 space-y-2">
          ...
          <div className="lg:col-span-7">
            <div className="p-6 sm:p-8 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-2xl space-y-6">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-slate-100 placeholder-slate-600 focus:outline-none focus:border-blue-500 font-sans text-xs"
                    />
                  </div>

                  <div className="space-y-1.5">
                    <label className="font-mono text-[11px] text-slate-400 uppercase">Your Email</label>
                    <input
                      type="email"
                      name="user_email"
                ...
                <div className="space-y-1.5">
                  <label className="font-mono text-[11px] text-slate-400 uppercase">Subject / Role</label>
                  <input
                    type="text"
                    name="subject"
                ...
                <div className="space-y-1.5">
                  <label className="font-mono text-[11px] text-slate-400 uppercase">Message Payload</label>
                  <textarea
                    name="message"
                    rows={4}
                    ...
                    className="w-full px-4 py-2.5 rounded-xl bg-slate-950 border border-slate-800 text-slate-100 placeholder-slate-600 focus:outline-none focus:border-blue-500 font-sans text-xs resize-none"
                  />
                </div>
