...
const Footer = ({ onOpenTerminal }) => {
  ...
  return (
    <footer className="bg-slate-950 border-t border-slate-900 text-slate-400 font-sans text-xs">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 items-center border-b border-slate-900 pb-8">
          {/* Brand */}
          <div className="space-y-2 text-center md:text-left">
            <div className="flex items-center justify-center md:justify-start gap-2">
              ...
              <span className="font-display font-bold text-white text-sm">Nirmal Koswatta</span>
            </div>
          ...
          {/* Nav Quick Links */}
          <div className="flex flex-wrap justify-center gap-4 font-mono text-[11px]">
          ...
          <div className="flex items-center justify-center md:justify-end gap-3">
            ...
            <button
              onClick={scrollToTop}
              className="p-2 rounded-lg bg-blue-600 hover:bg-blue-500 text-white transition-colors ml-2"
