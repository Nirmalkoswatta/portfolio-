      ...
      <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-12 gap-12 lg:gap-8 items-center">
        ...
        >
          ...
          <div className="space-y-2">
            <h1 className="font-display text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight text-white uppercase leading-[1.08]">
              NIRMAL <br />
              <span className="bg-gradient-to-r from-blue-400 via-cyan-400 to-indigo-400 bg-clip-text text-transparent">
                KOSWATTA
              </span>
            </h1>
            <p className="font-mono text-sm sm:text-base font-semibold text-blue-400 uppercase tracking-wider">
              {/* Devops Title */}
          ...
          <div className="flex flex-wrap items-center gap-4 pt-2">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-3.5 rounded-xl bg-slate-900/80 hover:bg-slate-800 border border-slate-700/80 text-slate-200 hover:text-white font-medium text-sm transition-all duration-300 backdrop-blur-sm hover:-translate-y-0.5"
              data-cursor="CV"
            >
            ...
            <div className="flex items-center gap-2 pl-2">
              <a
                ...
                className="p-3 rounded-xl bg-slate-900/60 border border-slate-800 text-slate-400 hover:text-white hover:border-slate-700 transition-all hover:-translate-y-0.5"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-xl bg-slate-900/60 border border-slate-800 text-slate-400 hover:text-blue-400 hover:border-slate-700 transition-all hover:-translate-y-0.5"
          ...
          <div className="pt-4 border-t border-slate-800/80 flex flex-wrap items-center gap-2">
            ...
            {['AWS', 'Kubernetes', 'Docker', 'Terraform', 'GitHub Actions', 'Grafana', 'Prometheus', 'DevSecOps', 'Oracle DB'].map((tech) => (
              <span
                key={tech}
                className="font-mono text-[11px] px-2.5 py-1 rounded-md bg-slate-900/80 border border-slate-800/90 text-slate-300"
              >
                {tech}
              </span>
            ))}
        ...
        <motion.div
          ...
          className="lg:col-span-5 h-[380px] sm:h-[440px] lg:h-[520px] w-full flex items-center justify-center relative"
        >
          {/* Subtle Backing Grid Card */}
          <div className="absolute inset-0 rounded-2xl border border-slate-800/50 bg-gradient-to-b from-slate-900/20 to-transparent pointer-events-none" />
          
          {/* Technical corner marks */}
          <div className="absolute top-2 left-2 font-mono text-[9px] text-slate-600 uppercase tracking-wider">
            [SYS::CLOUDOPS-ROBOT-01]
          </div>
          <div className="absolute top-2 right-2 font-mono text-[9px] text-emerald-500 uppercase tracking-wider flex items-center gap-1">
          ...
          <div className="absolute bottom-2 left-3 right-3 flex items-center justify-between font-mono text-[9px] text-slate-600">
