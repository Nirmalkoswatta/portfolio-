  ...
  return (
    <section id="skills" className="section-padding relative overflow-hidden">
      <div className="container-custom">
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
            <div>
              <h2 className="heading-lg tracking-tight uppercase">
                DEVOPS <span className="text-blue-400">COMMAND CENTER</span>
              </h2>
            ...
            <div className="flex flex-wrap items-center gap-3 font-mono text-[10px] text-slate-400">
              ...
              <span className="px-2 py-0.5 rounded bg-blue-500/10 border border-blue-500/30 text-blue-400">CORE</span>
              <span className="px-2 py-0.5 rounded bg-emerald-500/10 border border-emerald-500/30 text-emerald-400">EXPERIENCED</span>
              <span className="px-2 py-0.5 rounded bg-cyan-500/10 border border-cyan-500/30 text-cyan-400">WORKING</span>
            </div>
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                <div className="space-y-1.5 pt-3 border-t border-slate-800">
                  <span className="font-mono text-[9px] text-slate-500 uppercase block">CAPABILITIES</span>
                  <div className="flex flex-wrap gap-1.5">
                    {skill.context.map((ctx) => (
                      <span
                        key={ctx}
                        className="font-mono text-[10px] px-2 py-0.5 rounded bg-slate-950 border border-slate-800/80 text-slate-300"
                      >
                        {ctx}
                      </span>
                    ))}
        ...
        <div className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-slate-900 via-slate-900 to-blue-950/40 border border-slate-800/80 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a
            href="#architecture"
            className="px-5 py-2.5 rounded-xl bg-slate-800 hover:bg-slate-700 border border-slate-700 text-white font-mono text-xs font-semibold whitespace-nowrap transition-colors"
          >
            VIEW ARCHITECTURE →
          </a>
        </div>
