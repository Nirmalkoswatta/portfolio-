      ...
      <div className="container-custom">
        ...
        <div className="mb-12">
          ...
          <h2 className="heading-lg tracking-tight uppercase">
            ENGINEERING <span className="text-blue-400">MINDSET</span>
          </h2>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-start">
          ...
          <motion.div
            ...
            className="lg:col-span-7 space-y-6 text-slate-300 leading-relaxed font-sans"
          >
            ...
            <div className="grid sm:grid-cols-2 gap-4 pt-4">
              {highlights.map((item, idx) => (
                <div
                  key={idx}
                  className="p-4 rounded-xl bg-slate-900/60 border border-slate-800/80 hover:border-slate-700 transition-colors space-y-2"
                >
          ...
          <motion.div
            ...
            className="lg:col-span-5 p-6 rounded-2xl bg-slate-900/80 border border-slate-800 shadow-xl space-y-6"
          >
            <div className="flex items-center justify-between border-b border-slate-800 pb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-display font-bold text-base text-white">Nirmal Koswatta</h3>
                  <p className="font-mono text-xs text-blue-400">Associate DevOps Engineer</p>
                </div>
              </div>
              <span className="font-mono text-[10px] text-emerald-400 bg-emerald-500/10 px-2 py-1 rounded border border-emerald-500/20 flex items-center gap-1">
            ...
            <div className="space-y-3 font-mono text-xs">
              ...
              <div className="flex items-start gap-3 text-slate-300">
                ...
                <div>
                  ...
                  <span className="text-slate-400 block text-[11px]">University of Bedfordshire / SLIIT CityUNI</span>
                </div>
              </div>
